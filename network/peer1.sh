...
export CORE_PEER_TLS_CERT_FILE="${PWD}"/crypto-config/peerOrganizations/blockchain.gigi.com.vn/peers/peer0.blockchain.gigi.com.vn/tls/server.crt
export CORE_PEER_TLS_KEY_FILE="${PWD}"/crypto-config/peerOrganizations/blockchain.gigi.com.vn/peers/peer0.blockchain.gigi.com.vn/tls/server.key
export CORE_PEER_TLS_ROOTCERT_FILE="${PWD}"/crypto-config/peerOrganizations/blockchain.gigi.com.vn/peers/peer0.blockchain.gigi.com.vn/tls/ca.crt
export CORE_PEER_ID=peer0.blockchain.gigi.com.vn
...
export CORE_PEER_MSPCONFIGPATH="${PWD}"/crypto-config/peerOrganizations/blockchain.gigi.com.vn/peers/peer0.blockchain.gigi.com.vn/msp
export CORE_OPERATIONS_LISTENADDRESS=127.0.0.1:8446
export CORE_PEER_FILESYSTEMPATH="${PWD}"/data/peer0.blockchain.gigi.com.vn
export CORE_LEDGER_SNAPSHOTS_ROOTDIR="${PWD}"/data/peer0.blockchain.gigi.com.vn/snapshots
