...
export ORDERER_GENERAL_TLS_PRIVATEKEY="${PWD}"/crypto-config/ordererOrganizations/gigi.com.vn/orderers/orderer.gigi.com.vn/tls/server.key
export ORDERER_GENERAL_TLS_CERTIFICATE="${PWD}"/crypto-config/ordererOrganizations/gigi.com.vn/orderers/orderer.gigi.com.vn/tls/server.crt
...
export ORDERER_GENERAL_TLS_ROOTCAS="${PWD}"/crypto-config/ordererOrganizations/gigi.com.vn/orderers/orderer.gigi.com.vn/tls/ca.crt
